...
class CellViT(nn.Module):
    ...
    def forward(self, x: torch.Tensor, retrieve_tokens: bool = False) -> dict[str, Any]:
        """Forward pass
    ...
    def create_upsampling_branch(self, num_classes: int) -> nn.Sequential:
...
class CellViTSAM(CellViT):
    ...
    def load_pretrained_encoder(self, model_path: Path | str):
