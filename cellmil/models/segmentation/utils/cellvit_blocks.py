...
from cellmil.models.encoders.ViT.SAM.image_encoder import ImageEncoderViT
from cellmil.models.encoders.ViT.vits_histo import VisionTransformer
...
class ViTCellViT(VisionTransformer):
    ...
    def forward(
        ...
        """
        extracted_layers: list[torch.Tensor] = []
        ...
        return output, x[:, 0], extracted_layers # type: ignore
...
class ViTCellViTDeit(ImageEncoderViT):
    ...
    def forward(self, x: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor, list[torch.Tensor]]:
        ...
        return torch.mean(_output, axis=-1), output, extracted_layers # type: ignore
