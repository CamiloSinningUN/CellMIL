...
class Storage:
    ...
    def save_masks(self, mask_images: Dict[str, ImageType]):
        """Save tissue masks
    ...
    def save_annotation_mask(self, mask_images_annotations: Dict[str, ImageType]):
    ...
    def save_thumbnails(self, thumbnails: Dict[str, ImageType]):
