...
class GraphMILAttentionExtractor(BaseAttentionExtractor):
    ...
    def _apply_aggregation(
        ...
        if aggregation == AttentionAggregation.pooling_only:
        ...
        elif aggregation == AttentionAggregation.gnn_only:
            if gnn_attention:
        ...
        elif aggregation == AttentionAggregation.gnn_layer:
        ...
        elif aggregation == AttentionAggregation.random_walk:
...
class AttentionExtractorFactory:
    ...
    def create_extractor(
        model: Pl.LightningModule, config: ExplainerCreatorConfig
