...
class PatchedWSIInference(Dataset[Tuple[torch.Tensor, dict[str, Any]]]):
    ...
    def collate_batch(batch: List[Tuple[torch.Tensor, dict[str, Any]]]) -> Tuple[torch.Tensor, list[dict[str, Any]]]:
        ...
        Args:
            batch (List[Tuple[torch.Tensor, dict]]): Input batch consisting of a list of tuples (patch, patch-metadata)
